 ...
 * @hidden
 */
export declare function resetRowIndex(gObj: IGrid, rows: Row<Column>[], rowElms: HTMLTableRowElement[], index?: number): void;
/**
 * @param {IGrid} gObj - Defines the grid object
 ...
 * @hidden
 */
export declare function getNumberFormat(numberFormat: string, type: string, isExcel: boolean): string;
/**
